...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void wearableDataSync(){
        ...
        if (cursor.moveToFirst()) {
            ...
            Bitmap weather_icon = BitmapFactory.decodeResource(context.getResources(),iconId);
            ...
            Asset asset = createAssetFromBitmap(weather_icon);
            ...
            Wearable.DataApi.putDataItem(mGoogleApiClient,putDataReq).setResultCallback(new ResultCallback<DataApi.DataItemResult>(){
                ...
                public void onResult(DataApi.DataItemResult dataItemResult) {
                    if(!dataItemResult.getStatus().isSuccess()){
                        Log.e(LOG_TAG,"failed to store wearable sunshine data item locally");
                    }else {
                        Log.d(LOG_TAG,"Successfully store wearable sunshine data item locally");
                    }
                }
            });
        }
